                ...
                <div class="login-form">
                    <form action="#" method="post">
                        ...
                        <select name="status">
                            ...
                            <option value="2" <?php if ($order['status'] == 2) echo ' selected="selected"'; ?>>Обработанный</option>
                            <option value="3" <?php if ($order['status'] == 3) echo ' selected="selected"'; ?>>Оплаченный</option>
                            <option value="4" <?php if ($order['status'] == 4) echo ' selected="selected"'; ?>>Отправленный</option>
                            <option value="5" <?php if ($order['status'] == 5) echo ' selected="selected"'; ?>>Выполненный</option>
                        </select>
                        <br>
                        <br>
